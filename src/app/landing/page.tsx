...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description: 'Accédez à des formations de qualité adaptées à votre niveau et à vos objectifs professionnels.',
    ...
    },
    {
      ...
      description: 'Participez à des événements enrichissants et développez votre réseau professionnel.',
      color: 'text-blue-500',
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Les services proposés sont exceptionnels. L\'accompagnement est personnalisé et très professionnel.',
      avatar: 'FS',
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-gray-600 hover:text-orange-600 transition-colors font-medium">Services</a>
              <a href="#about" className="text-gray-600 hover:text-orange-600 transition-colors font-medium">À Propos</a>
              <a href="#testimonials" className="text-gray-600 hover:text-orange-600 transition-colors font-medium">Témoignages</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-4 py-4 space-y-4">
              <a href="#features" className="block text-gray-600 hover:text-orange-600 transition-colors font-medium">Services</a>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-white mb-12 max-w-4xl mx-auto leading-relaxed">
              Découvrez Campus Téranga, la plateforme qui accompagne les étudiants 
              dans leur parcours éducatif et professionnel au Sénégal.
            </p>
      ...
      <section ref={statsRef} className="py-20 bg-gradient-to-r from-slate-50 to-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl ${stat.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                  <stat.icon className="h-8 w-8 text-white" />
                </div>
                <div className={`text-4xl md:text-5xl font-bold ${stat.color} mb-3 group-hover:scale-105 transition-transform duration-300`}>
                  {stat.number}+
                </div>
      ...
      <section id="features" className="py-24 bg-gradient-to-br from-white via-slate-50 to-orange-50 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-800 max-w-4xl mx-auto leading-relaxed">
              Une plateforme complète pour accompagner votre réussite académique et professionnelle au Sénégal
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                {/* Background Gradient */}
                <div className={`absolute inset-0 rounded-3xl ${feature.bgColor} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
                
                <div className="relative z-10">
                  {/* Icon */}
                  <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl ${feature.iconBg} flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg`}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-white/90 leading-relaxed">
                Réseau professionnel étendu pour connecter les étudiants avec des opportunités de carrière et des mentors.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-white/90 leading-relaxed">
                Événements culturels et professionnels pour enrichir votre expérience étudiante et développer votre réseau.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-white/90 leading-relaxed">
                Support administratif complet pour faciliter vos démarches et votre intégration dans le système éducatif.
              </p>
            </div>
      ...
      <section id="testimonials" className="py-24 bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Découvrez les expériences de nos étudiants qui ont transformé leur parcours avec Campus Téranga
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start group">
                    ...
                    <span className="text-gray-700 font-medium group-hover:text-gray-900 transition-colors duration-200">{benefit}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-blue-600 rounded-3xl p-10 text-white shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white mb-8 text-lg leading-relaxed">
                    &quot;Accompagner chaque étudiant dans son parcours éducatif et professionnel 
                    au Sénégal, en créant des opportunités de croissance et de réussite.&quot;
                  </p>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white mb-12 max-w-3xl mx-auto leading-relaxed">
            Rejoignez la communauté Campus Téranga et découvrez toutes les opportunités 
              qui vous attendent au Sénégal. Votre parcours de réussite commence ici !
          </p>
      ...
      <section id="contact" className="py-24 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Notre équipe est disponible pour vous accompagner dans votre parcours et répondre à toutes vos questions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-8 text-lg leading-relaxed max-w-md">
                ...
                Formations, événements, services et communauté étudiante.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Formations', 'Événements', 'Services Étudiants', 'Communauté'].map((item, index) => (
                  <li key={index}>
                    <a href="#" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 text-lg">
                      {item}
                    </a>
                  </li>
                ))}
